  ...
  return (
    <div className="space-y-4">
      ...
      <Alert>
        ...
        <AlertDescription>
          الاستثناء يُمنح لمستخدم واحد فقط ويُضاف <strong>فوق</strong> صلاحيات نوعه ومجموعاته
          (لا يلغيها). القاعدة الصحيحة: ابنِ الصلاحيات في الأنواع والمجموعات، واستخدم الاستثناء
          للحالات النادرة. للمنع الصريح استخدم شاشة سياسات الوصول.
        </AlertDescription>
      </Alert>
