                  ...
                  <TableRow key={customer.id}>
                    ...
                    <TableCell>
                      <div className="flex gap-2">
                        <Button variant="outline" size="sm" onClick={() => navigate(`/sales/customers/${customer.id}/statement`)} title="كشف الحساب">
                          <FileText className="h-4 w-4" />
                        </Button>
                        <Button variant="outline" size="sm" onClick={() => handleEdit(customer)} title="تعديل">
                          <Edit className="h-4 w-4" />
                        </Button>
                        <Button variant="outline" size="sm" onClick={() => setDeletingId(customer.id)} title="حذف">
